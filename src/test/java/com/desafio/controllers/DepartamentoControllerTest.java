...
public class DepartamentoControllerTest {
        ...
        public void shouldSaveNewDepartamento() throws Exception {
                ...
                when(departamentoService.salvarDepartamento(any(Departamento.class)))
                                .thenReturn(newDepartamento.toDTO());
                ...
                // Assert response
                DepartamentoDTO responseDTO = new ObjectMapper().readValue(mvcResult.getResponse().getContentAsString(),
        ...
        public void shouldListDepartamentosComQuantidade() throws Exception {
                ...
                // Parsing and asserting response
                List<DepartamentoDTO> responseDTOs = new ObjectMapper().readValue(
                                mvcResult.getResponse().getContentAsString(),
                                new TypeReference<List<DepartamentoDTO>>() {
                                });
